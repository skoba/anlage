...
| [2026-08-23--bmi_calculation--height-v2-pathcard-after-dropzone.png](2026-08-23--bmi_calculation--height-v2-pathcard-after-dropzone.png) | `spec/fixtures/opt/bmi_calculation.opt`（openehr-rails demo_assets由来、lang=en）、`skoba/anlage#5` | #5案Aブロック解除の実演。ドロップゾーン経由でbmi_calculation.optを登録し、`openEHR-EHR-OBSERVATION.height.v2` at0004のpathcard抽出（4カード中1件、property openehr::122・units cm・LOINC code_binding付き）を確認。beforeは無し（fixture取り込み後の初通過記録） |
